import { o as onDestroy, c as create_ssr_component, j as createEventDispatcher, e as escape, f as add_attribute, d as each, v as validate_component, p as spread, q as escape_object, r as escape_attribute_value, t as compute_slots } from "./index2.js";
import { computePosition, autoUpdate, offset, flip, shift } from "@floating-ui/dom";
function regexForSearch(query) {
  query = query.replace(/a/gi, "[AÁÀÂÃ]").replace(/e/gi, "[EÉÈÊ]").replace(/i/gi, "[IÍÌÎ]").replace(/o/gi, "[OÓÒÔÕ]").replace(/u/gi, "[UÚÙÛ]").replace(/c/gi, "[CÇ]");
